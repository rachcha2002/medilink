...
function ReportList() {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        ...
        // Combine the labReports and radiologyReports into one array
  ...
  return (
    <main id="main" className="main">
      <PageTitle title="Reports" url="/mltstaff/reportlist" />
      <Container
        className="p-4"
      ...
      >
        ...
        {error && (
          <Alert variant="danger">Error fetching reports: {error}</Alert>
        )}
            ...
            <Modal.Body>
              ...
              <Row className="mt-1">
                <Col>
                  ...
                  {selectedReport.laboratoristId ||
                    selectedReport.radiologistId}
                </Col>
              </Row>
              <Row className="mt-1">
                <Col>
