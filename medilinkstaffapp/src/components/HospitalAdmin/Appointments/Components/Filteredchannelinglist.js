...
function Filteredchannelinglist({ appointments }) {
          ...
          <div style="padding: 30px; font-family: 'Poppins', sans-serif; line-height: 1.6; color: #333;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
              <div>
                ...
                <h5 style="color: #555; margin: 0;">Channeling Appointment List</h5>
              </div>
    ...
    const filteredAppointments = appointments.filter(appointment => {
        ...
        const nameMatch = appointment.username.toLowerCase().includes(searchName.toLowerCase()) || appointment.doctorName.toLowerCase().includes(searchName.toLowerCase());
