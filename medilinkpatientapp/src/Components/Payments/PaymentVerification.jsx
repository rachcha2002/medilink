    ...
    try {
      ...
      html2pdf()
        ...
        .then(async (pdf) => {
          ...
          const emailOptions = {
            to: `${billData.patientEmail}`, // Patient's email address
            subject: `Payment Confirmation for Bill ${billData.billNo}`,
            html: `<p><b>Dear ${billData.patientName},</b></p>
                  <p>Your payment for the invoice with Bill No. <strong>${billData.billNo}</strong> has been successfully processed. You can download your invoice by clicking the link below:</p>
