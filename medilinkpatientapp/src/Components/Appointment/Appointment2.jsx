...
const Appointment2 = () => {
  ...
  const onSubmit = async (event) => {
    ...
    setLoading(true);
  const dataToSubmit = {
    ...formData, // Spread the formData state
    userid: 'u001', // Add static or constant values
    type: 'Channeling',
    username: 'tharii',
    email: 'tharii@gmail.com',
    hospitalId: 'H001',
    status: 'pending',
  };
  console.log(dataToSubmit);
  
  const res = await fetch("http://localhost:5000/api/appointment/makeappointment", { // Adjust the endpoint to your backend route
    method: "POST",
    headers: {
